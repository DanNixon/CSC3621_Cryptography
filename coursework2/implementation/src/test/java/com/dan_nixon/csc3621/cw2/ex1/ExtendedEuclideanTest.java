...
public class ExtendedEuclideanTest
{
  ...
  {
    final BigInteger x = BigInteger.valueOf(240);
    final BigInteger y = BigInteger.valueOf(46);
    ...
    assertEquals(BigInteger.valueOf(2), ee.getD());
    assertEquals(BigInteger.valueOf(-9), ee.getS());
    assertEquals(BigInteger.valueOf(47), ee.getT());
